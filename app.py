...
def train_model(data):
    # Assume your time series data has 'Date' and 'Price' columns
    ...
    # y = data['Price']
    y = data[data.columns[data.columns.str.lower() == 'price']].squeeze()
...
def main():
    ...
    if uploaded_file is not None:
        ...
        input_features = st.form(key='prediction_form').beta_columns(4)
        for col in ['Year', 'Month', 'Day', 'DayOfWeek']:
            input_features[col] = input_features.number_input(f'Enter {col}', value=2023)
